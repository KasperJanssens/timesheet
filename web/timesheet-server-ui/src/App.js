...
import {CustomerCreate, CustomerList, CustomerShow} from "./Customer";
...
const App = () => (
    <Admin
        ...
        <Resource id={"invoice"} name={"invoice"} list={InvoiceList} create={InvoiceCreate} show={InvoiceShow}/>
        <Resource id={"customer"} name={"customer"} list={CustomerList} show={CustomerShow} create ={CustomerCreate}/>
